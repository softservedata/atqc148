...
public final class Report {
    ...
    /**
     * Write testNG log with specified message color.
     *
     * @param message message to log.
     * @param color   HEX vale of color or color name('red', 'green' etc.).
     *                If not existed color is entered, default - black color will be used.
     */
